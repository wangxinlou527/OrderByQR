 ...
 * 主页
 */
public class OrderAdapter extends BaseQuickAdapter<NowSeatEntity.DataBean, BaseViewHolder> {

    private int mPosition;


    public OrderAdapter(int layoutResId, @Nullable List<NowSeatEntity.DataBean> data) {
        super(layoutResId, data);
    }


    @Override
    protected void convert(BaseViewHolder helper,NowSeatEntity.DataBean item) {
        ...
        helper.setText(R.id.item_id,String.valueOf(helper.getAdapterPosition() + 1) )
                ...
                .setText(R.id.item_money, StrUtil.fmtMicrometer(item.getPrice()))
                .setText(R.id.item_attribute,item.getAttribute());
