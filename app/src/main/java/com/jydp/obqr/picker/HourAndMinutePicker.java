...
public class HourAndMinutePicker extends LinearLayout implements
    ...
    public String getHour() {
        if(mHourPicker.getCurrentPosition() < 10) {
            return "0" + mHourPicker.getCurrentPosition();
        }else{
            return String.valueOf(mHourPicker.getCurrentPosition());
        }
    }
    ...
    public String getMinute() {
        if(mMinutePicker.getCurrentPosition() < 10) {
            return "0" + mMinutePicker.getCurrentPosition();
        }else{
            return String.valueOf(mMinutePicker.getCurrentPosition());
        }
    ...
    public interface OnTimeSelectedListener {
         ...
         */
        void onTimeSelected(String hour, String minute);
    }
}
