 ...
 */
public class StaffPicker extends WheelPicker<StaffEntity.DataBean>{

    private OnDataSelectedListener mOnDataSelectedListener;

    public StaffPicker(Context context) {
        this(context, null);
    }

    public StaffPicker(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StaffPicker(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        setCyclic(isCyclic);
        ...
        setOnWheelChangeListener(new OnWheelChangeListener<StaffEntity.DataBean>() {
            @Override
            public void onWheelSelected(StaffEntity.DataBean item, int position) {
    ...
    public StaffEntity.DataBean getData(){
    ...
    public interface OnDataSelectedListener {
        ...
        void onTimeSelected(StaffEntity.DataBean data);
    }
