 ...
 */
public class DataPicker extends WheelPicker<SeatListEntity.DataBean>{
...
//        setCyclic(isCyclic);
        ...
        setOnWheelChangeListener(new OnWheelChangeListener<SeatListEntity.DataBean>() {
            @Override
            public void onWheelSelected(SeatListEntity.DataBean item, int position) {
    ...
    public SeatListEntity.DataBean getData(){
    ...
    public interface OnDataSelectedListener {
        ...
        void onTimeSelected(SeatListEntity.DataBean data);
    }
