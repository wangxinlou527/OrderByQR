...
public class PickerScrollView extends View {
    ...
    private List<SeatListEntity.DataBean> mDataList;
    /**
    ...
    public void setData(List<SeatListEntity.DataBean> datas) {
        mDataList = datas;
    ...
    private void moveHeadToTail() {
        SeatListEntity.DataBean datasBean = mDataList.get(0);
        mDataList.remove(0);
        mDataList.add(datasBean);
    }

    private void moveTailToHead() {
        SeatListEntity.DataBean datasBean = mDataList.get(mDataList.size() - 1);
    ...
    private void drawData(Canvas canvas) {
        ...
        String textData = mDataList.get(indexs).getNumber();
    ...
    public interface onSelectListener {
        void onSelect(SeatListEntity.DataBean pickers);
    }
}
